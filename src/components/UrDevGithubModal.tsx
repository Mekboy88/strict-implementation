            ...
            <>
              <div className="flex items-start gap-3 rounded-xl border border-white/20 bg-white/10 px-4 py-3">
                ...
                <div className="flex-1">
                  ...
                  {showAccount && (
                    <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-[11px] text-slate-100">
                      {showAccount.avatarUrl ? (
                        ...
                        <div className="flex h-5 w-5 items-center justify-center rounded-full bg-white/20 text-[9px] uppercase">
