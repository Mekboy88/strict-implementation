...
export const CompletionCard = ({ projectName }: CompletionCardProps) => {
  return (
    <div className="inline-flex items-start gap-3 rounded-full px-6 py-3 border border-white/10 bg-gradient-to-br from-white/[0.02] via-red-500/[0.01] to-black/[0.02] backdrop-blur-sm">
