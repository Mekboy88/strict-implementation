            ...
            <div className="border-t border-white/10 px-4 py-3">
              <div className="rounded-2xl border border-white/10 bg-slate-950/95 p-3 space-y-3">
                ...
                <div className="flex items-end gap-2 rounded-xl bg-black/80 px-3 py-2">
                  ...
                  />
                  <button className="inline-flex items-center justify-center rounded-lg bg-sky-500 px-3 py-1.5 text-[11px] font-semibold text-black shadow-[0_0_18px_rgba(56,189,248,0.7)] hover:bg-sky-400">
