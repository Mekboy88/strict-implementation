              ...
              <div className="rounded-2xl border border-white/10 space-y-3">
                ...
                <div className="flex flex-col gap-2 rounded-2xl bg-neutral-800 px-3 py-3">
                  <textarea
                    ...
                    spellCheck={true}
                    className="flex-1 bg-transparent text-base text-slate-100 placeholder:text-slate-500 outline-none resize-none min-h-[40px] px-0 py-1 transition-all duration-300 selection:bg-blue-500/60 selection:text-white overflow-y-auto"
