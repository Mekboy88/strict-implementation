      ...
      <header className="flex items-center justify-between border-b border-white/10 bg-black/90 pl-1 pr-4 py-3 sm:pl-2 sm:pr-6 lg:pl-2 lg:pr-8">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center gap-1 hover:bg-slate-800 rounded px-1 transition-colors outline-none">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="hidden lg:flex w-12 flex-col items-center justify-between border-r border-white/10 bg-[#030711] py-3">
          <div className="flex flex-col items-center gap-3">
            ...
            <svg fill="currentColor" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 transition-transform hover:scale-110 cursor-pointer">
