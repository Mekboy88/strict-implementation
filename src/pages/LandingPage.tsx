        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-xs">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-96 bg-neutral-900 border-neutral-700 z-50 p-2">
                <DropdownMenuItem 
                  onClick={() => handleOAuthLogin("google")}
                  className="cursor-pointer hover:bg-neutral-800 focus:bg-neutral-800 py-4 px-4 text-base"
                >
                  <svg className="h-6 w-6 mr-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
