              ...
              <div className="mt-4 text-left w-full">
                <div className="relative rounded-3xl bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.35),_transparent_65%),_radial-gradient(circle_at_bottom,_rgba(129,140,248,0.4),_transparent_70%)] p-[1px] shadow-[0_0_45px_rgba(15,23,42,0.9)]">
                  ...
                  <button
                    ...
                    className="absolute bottom-4 right-4 sm:bottom-5 sm:right-5 flex items-center gap-2 rounded-full bg-sky-500 px-4 py-1.5 text-[11px] font-semibold text-black shadow-[0_0_26px_rgba(59,130,246,0.9)] hover:bg-sky-400 transition-all cursor-pointer z-10"
                  >
                    <span className="select-none">Build with UR-DEV</span>
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-black/20 text-[10px] select-none">
                      →
                    </span>
                  </button>
