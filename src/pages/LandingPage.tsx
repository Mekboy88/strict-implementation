                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="space-y-3 w-full">
                    <DropdownMenuItem 
                      ...
                      className="flex items-center justify-center gap-3 w-full py-3 rounded-full bg-neutral-800 hover:bg-neutral-700 text-neutral-100 text-sm border border-neutral-700 transition shadow-lg cursor-pointer"
                    >
