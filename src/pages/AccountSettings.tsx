    ...
    <div className="w-full h-full rounded-2xl border border-neutral-600 bg-neutral-800 shadow-[0_0_120px_rgba(15,23,42,0.85)] flex overflow-hidden">
          ...
          <main className="flex-1 bg-neutral-800 px-8 py-6 overflow-y-auto">
            ...
            <div className="space-y-6 text-[14px] pb-4">
              {/* Overview */}
              <section className="rounded-xl border border-neutral-700 bg-neutral-800">
                ...
                <div className="px-5 py-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 rounded-lg border border-neutral-700 bg-neutral-800 px-3 py-2 text-[13px]">
                        <input
                          type="radio"
              ...
              {/* Danger zone */}
              <section className="rounded-xl border border-neutral-700 bg-neutral-800">
                <div className="border-b border-neutral-700 px-5 py-3 flex items-center gap-2">
